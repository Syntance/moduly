...
import { demoAnalyticsDashboard } from "@/lib/analytics-demo-data";
...
const TABS: Array<{ id: StatisticsTab; label: string; description: string }> = [
  { id: "sales", label: "Statystyki sprzedażowe", description: "Przychód, zamówienia, dostawa i produkty ze sklepu" },
  { id: "analytics", label: "Analityka", description: "Ruch i konwersja z Google Analytics 4 oraz PostHog" },
];
...
export function StatisticsTabs() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {tab === "sales" ? <SalesStatisticsView /> : <AnalyticsPanel data={demoAnalyticsDashboard} />}

      <Badge tone="neutral" className="self-start">Dane przykładowe · czerwiec 2026</Badge>
    </div>
  );
}
